...
print(rms.eval(lbasic.lm, datasets.leading, FALSE, outvar="ld.pcc.rate"))
cat("\nprate (degree=1):\t\tlprate.lm\n")
print(rms.eval(lprate.lm, datasets.leading, FALSE, outvar="ld.pcc.rate"))
cat("\nprate (degree 1):\t\tlprate.earth.d1\n")
print(rms.eval(lprate.earth.d1, datasets.leading, FALSE, outvar="ld.pcc.rate"))
